...
- The header switches at the sanctioned 999/1000px pair, not the 768px page layout: below it (phones and tablets) the header is the 60px bar with the popover menu; from 1000px it is a 68px bar on every page type, hero and solid alike, with the wordmark overhanging the bar (absolute, `top: 14px`) and the nav padded clear of it. The desktop nav only just fits at 1000px, so do not move the switch lower. The front page hides the bar wordmark wherever its desktop hero shows the large one (≥769px).
