...
faq:
  ...
  - q: 'Onko Pride-liputus pelkkä symboli?'
    a: 'Niille, jotka ovat kohdanneet syrjintää tai kiusaamista identiteettinsä vuoksi, liputus on hyvin konkreettinen viesti siitä, että kunta näkee ja arvostaa heitä. THL:n kouluterveyskyselyn mukaan joka seitsemäs seksuaalivähemmistöihin kuuluva yläkoululainen kokee kiusaamista viikoittain, joten näkyvillä teoilla on erityistä merkitystä.'
  - q: 'Miksi kuntien rooli korostuu juuri nyt?'
    a: 'Yhdenvertaisuutta ja vähemmistöjä tukevien toimijoiden asemaa kyseenalaistetaan julkisessa keskustelussa aiempaa näkyvämmin, ja juuri paikallisella tasolla kohtaamme toisemme kouluissa, nuorisotiloissa ja harrastuksissa. Kuntalaki velvoittaa edistämään asukkaiden hyvinvointia, eikä velvoite pääty lippusalkoon.'
  - q: 'Miten liputuspäätös syntyi Kirkkonummella?'
    a: 'Minun ja vihreän valtuustoryhmän kesäkuussa 2025 jättämästä aloitteesta vuosittaisesta Pride-liputuksesta, jonka valtuusto hyväksyi maaliskuussa 2026 äänin 30–14. Lippu nostettiin salkoon ensimmäistä kertaa 22.6.2026, ja jatkossa se nostetaan vuosittain kahdesti.'
---
