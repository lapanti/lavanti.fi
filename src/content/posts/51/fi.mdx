...
faq:
  ...
  - q: 'Mitä digitaalinen itsenäisyys tarkoittaa?'
    a: 'Sitä, että hallitsemme yhteiskuntaamme: kriittisten palveluiden saatavuudesta ja tietoon pääsystä päätetään Suomessa. Riippuvuuden hyväksikäytön todennäköisyys on pieni, mutta seuraukset olisivat katastrofaaliset, joten riskiä ei voi ohittaa.'
  - q: 'Miksi digitaalinen huoltovarmuus on tärkeää?'
    a: 'Valtiovarainministeriön muistion mukaan merkittävä osa julkishallinnon palveluista nojaa yhdysvaltalaisiin alustoihin, ja niiden estyminen voisi lamauttaa viranomaistoiminnan. Silti toimenpiteiksi on ehdotettu lähinnä kartoituksia, ja Turvasatama-konsepti pysähtyi rahoituksen puutteeseen.'
---
