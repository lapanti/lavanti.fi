...
faq:
  - q: 'Why did I vote against Västra?'
    a: 'The cost is over 38,000 euros a year, the agreement cannot be left before 2029 and not unilaterally even then, and it allows unexpected extra costs the council would not vote on. Kirkkonummi''s success is built on its proximity to the capital region, and the money belongs in education, schools and early childhood education.'
  - q: 'What kind of Kirkkonummi do we want to build?'
    a: 'One that makes use of its proximity to the capital region and invests in its strengths: nature, the living environment, transport links and high-quality services. Working channels of influence such as HSL and the MAL cooperation already exist, so resources should go there and into developing our own municipality.'
---
