...
faq:
  ...
  - q: 'Är Pride-flaggningen bara en symbol?'
    a: 'Nej. Upplevelsen av att bli accepterad och synlighet stöder bevisligen regnbågsungdomars välmående, och gemenskapens acceptans är kopplad till lägre risk för depression. Flaggan är ett synligt budskap som varje förbipasserande ser.'
  - q: 'Vad konkret behövs vid sidan av flaggningen?'
    a: 'Konkret arbete mot mobbning i skolorna, tillräckligt med kurators- och psykologtjänster samt en gemenskapskultur där olikhet är accepterad, inte bara tillåten. Flaggan är en startpunkt som förpliktar till att fortsätta i samma riktning.'
---
