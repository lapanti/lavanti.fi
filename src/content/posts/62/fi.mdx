...
faq:
  ...
  - q: 'Miksi Vihreät on markkinatalouden aito puolustaja?'
    a: 'Koska vihreä talouspolitiikka rakentuu kolmelle periaatteelle: haitat maksavat, kilpailu on reilua ja markkinat ovat läpinäkyvät. Kokoomus ajaa kamreritaloutta, Vasemmistoliitto sosialismia ja SDP samaa kuin Kokoomus reilummin, joten ulkoisvaikutukset huomioivalle markkinataloudelle ei ole Vihreitä parempaa vaihtoehtoa.'
  - q: 'Miksi vaihtaa Vihreisiin?'
    a: 'Kansa hakee vaihtoehtoa Kokoomukselle, ja Vihreiden kasvu tulee oikealta ja keskeltä. Vihreissä markkinatalous on vapaa epäreilusta kilpailusta, pienten ja uusien yritysten mahdollisuus ja pitkän tähtäimen kestävää kasvua, jossa verot kerätään haitoista eikä työstä.'
  - q: 'Mistä saa lisää tietoa markkinavihreästä taloudesta?'
    a: 'Kirjoituksesta velkajarrusta ja vihreästä talouspolitiikasta, tekstistä tekoälystä julkisten palvelujen taloudessa sekä talous-kategorian kirjoituksista. Muutosesitys 36/Lavanti ja puoluekokouspuhe ovat tässä kirjoituksessa kokonaisuudessaan.'
---
