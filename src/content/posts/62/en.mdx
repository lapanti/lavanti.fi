...
faq:
  ...
  - q: 'Why are the Greens the true defenders of the market economy?'
    a: 'Because green economic policy rests on three principles: harms have a price, competition is fair and markets are transparent. The National Coalition Party pursues accountant economics, the Left Alliance socialism and the SDP the same as the Coalition but fairer, so for a market economy that accounts for externalities there is no better option than the Greens.'
  - q: 'Why switch to the Greens?'
    a: 'Voters are looking for an alternative to the National Coalition Party, and the Greens'' growth comes from the right and the centre. In the Greens the market economy is free of unfair competition, an opportunity for small and new businesses, and long-term sustainable growth where taxes fall on harms, not on work.'
  - q: 'Where can I read more about market-green economics?'
    a: 'In the post on the debt brake and green economic policy, the post on AI in the economics of public services, and the economy category. Amendment 36/Lavanti and the congress speech are in this post in full.'
---
