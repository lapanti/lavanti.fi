...
faq:
    ...
    - q: 'Varför finns det här programmet också här?'
      a: 'Jag är med i de marknadsgröna och en av programmets undertecknare, och marknadsgrönt tänkande och ekonomi står i centrum för min riksdagsvalskampanj. Om att riva hindren för företagande skrev vi närmare i inlägget för Företagardagen, och hela nätverket presenteras på markkinavihreat.fi.'
    - q: 'Varför är De gröna marknadsekonomins sanna försvarare?'
      a: 'De gröna är Finlands ledande marknadsliberala parti utan band till gamla strukturer eller företag att skydda, till skillnad från de stora höger- och vänsterpartierna. Partiet driver pro-market-politik: öppen konkurrens, nya aktörer och prissättning av skador i stället för blind avreglering.'
---
